...
**Impact:** Phase 3 plan gains an erasure-integrity task; delete_account (Artifact B §1) may gain a pre-check; no Phase 2 change. — Models/ owns the canonical enums for every SQL type; features extend, never redeclare
**Date:** 2026-07-13
